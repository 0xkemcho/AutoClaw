...
import { MENTO_TOKENS, TOKEN_METADATA } from '@autoclaw/shared';
...
export function CurrencyManager({
  ...
  const allSelected = useMemo(
    () => MENTO_TOKENS.every((t) => allowedCurrencies.includes(t)),
    [allowedCurrencies],
  );
